...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EvokeWebsiteApi.ContactApi();
  });
  ...
  describe('ContactApi', function() {
    ...
    describe('showAllCategories', function() {
      it('should call showAllCategories successfully', function(done) {
        //uncomment below and update the code to test showAllCategories
        //instance.showAllCategories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
